  ...
  theaters.eachLayer(function (layer) {
    if (map.hasLayer(theaterLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
        $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/twitter.png"></td><td class="feature-name">' + layer.feature.properties.NAME + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      }
    }
  });
...
var theaters = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Tweet</th><td>" + feature.properties.NAME + "<tr><th>Emotion</th><td>" + "Happy" + "</td></tr>" + "</a></td></tr>" + "<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/samplet.geojson", function (data) {
...
{
  "Tweets Emotion": {
    "<img src='assets/img/twitter.png' width='24' height='28'>&nbsp;Tweets": theaterLayer
  }
};
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/twitter.png' width='24' height='28'>&nbsp;Theaters</h4>",
